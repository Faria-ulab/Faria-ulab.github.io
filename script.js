const projectData = {
    'research-proposal': {
        ...
        media: [{ type: 'document', src: 'assets/docs/Communication Research Proposa.pdf' }]
    },
    'mask-making': {
    ...
    'advanced-bangla': {
        ...
        description: 'This project presents an autobiographical creative narrative written by Faria Akter and Mohammad Tariquzzaman Shikdar, detailing a nostalgic childhood memory set in 2009 within the Sahrail Union of Singair, Manikganj. The story centers on a young boy named Nahid who is navigating the early days of his primary schooling, local village dynamics, and rural life. The narrative traces his transition from informal learning under "Badla\'s Mother" and visiting the neighborhood barber to his traumatic first days at Shivpur School, where he receives undeserved corporal punishment. The core emotional arc reaches its peak when a wealthy neighbor, Chunnu Munshi, buys Nahid’s beloved favorite yellow chick for fifty Taka to take to Dhaka for his daughter, leave the young protagonist deeply heartbroken and grieving the loss of his pet.',
        justification: 'Autobiographical literature and reflective narrative writing serve as critical tools for preserving rural cultural heritage, childhood psychology, and authentic local dialects. This project holds significant artistic value as it captures the subtle nuances of Bangladeshi village life, community bonds, socio-economic disparities, and the deep emotional connections children form with animals. By refining raw personal experiences into a structured literary piece, the story provides readers with a poignant, highly relatable portrayal of innocence, rural nostalgia, and early emotional loss. Furthermore, it highlights the importance of collaborative editing, demonstrating how personal real-life events can be elevated through creative prose, expressive dialogue, and meticulous stylistic polishing.',
        learnings: 'Through the execution of this project, participants gain comprehensive experience in transforming real-life personal memories into compelling literary narratives. Learners analyze storytelling techniques by structuring plot points, developing authentic character voices, and incorporating local dialect to enhance narrative depth. Additionally, participants master collaborative writing practices, engaging in multi-draft revising, grammatical correction, word choice refinement, and thematic enhancement. Ultimately, learners cultivate a stronger command over creative prose, learning how to evoke strong reader empathy and convey complex emotional experiences within a vividly rendered cultural backdrop.',
    ...
    'ict-development': {
        ...
        media: [{ type: 'document', src: 'assets/docs/Hasina_and_Friends_ICT4D_Case_Study.pdf' }]
    },
    'health-comm': {
        ...
        if (data.media && data.media.length > 0) {
            ...
            mediaItems.forEach(mediaItem => {
                if (mediaItem.type === 'image') {
                    const srcs = Array.isArray(mediaItem.src) ? mediaItem.src : [mediaItem.src];
                    srcs.forEach(src => {
